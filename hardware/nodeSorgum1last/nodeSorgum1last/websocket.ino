...
void socketSetup(){
  //USE_SERIAL.begin(115200);
    ...
    WiFiMulti.addAP("INOSE", "lekassembuh");
...
//    socketIO.begin("192.168.0.15", 5000,"/socket.io/?EIO=3");
     socketIO.begin("192.168.8.102", 5000,"/socket.io/?EIO=4");
...
void socketIoLoop(){
    ...
    if(now - messageTimestamp > 6000) {
        ...
        JsonObject param1 = array.createNestedObject();
         ...
         docsensor4["value"] =  getPhNoModul();


         StaticJsonDocument<200> docsensor5;
         docsensor5["id"] = idSensor5;
         docsensor5["name"] = sensor5Name;
         docsensor5["value"] = getSoilMoistureNoModul();

//         StaticJsonDocument<200> docsensor6;
//         docsensor5["id"] = idSensor6;
//         docsensor5["name"] = sensor6Name;
